...
def main() -> None:
    ...
    Runs the Chess Arena API server. Default configuration is host 0.0.0.0 and port 9001.
    ...
    parser.add_argument("--port", type=int, default=9001, help="Port to bind the server to (default: 9001)")
